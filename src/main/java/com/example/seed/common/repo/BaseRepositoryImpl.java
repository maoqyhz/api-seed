package com.example.seed.common.repo;
 ...
 */
@Transactional
public class BaseRepositoryImpl<T, PK extends Serializable> extends SimpleJpaRepository<T, PK> implements IBaseRepository<T, PK> {
